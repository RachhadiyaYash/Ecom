...
export default function ProductCard({ product }) {
  ...
  return (
    <div className="border border-primary p-4 md:w-aut0 rounded-lg shadow-sm hover:shadow-lg transition-shadow duration-200 ">
      ...
      <div className="flex h-[33px] items-center justify-between mt-2">
        ...
        <div className="flex justify-between items-center">
          {cartProduct ? (
            ...
            <button
              className="m-2 p-2 border border-primary rounded-full"
            ...
            >
              <svg
                ...
                height="16"
                fill="currentColor"
                className="bi bi-cart4 text-primary "
                viewBox="0 0 16 16"
              >
